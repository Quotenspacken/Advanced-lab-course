...
The maximum contrast was experimentally observed at a polarization angle of $\phi=\SI{130}{\degree}$. 
...
parameters are 
\begin{align*}
    a=(4.44 \pm 0.02)10^{-4} \quad\text{and}\quad b=1 \pm 0.0000008.
\end{align*}
...
\end{equation*}
The theoretical value at these conditions lays at $n_\text{theo}=1.00029$~\cite{air},
showing a good agreement with the experimental result.
