...
\end{equation}
In this expression, $\sigma_\text{Compton}$ denotes the total Compton scattering cross section. 
The symbol $\alpha$ represents the fine-structure constant, and $m$ denotes the electron mass. 
The variable $\hat{E}$ is the dimensionless photon energy defined as the ratio of the photon energy $E_\gamma$ to the electron mass $m$.
...
\end {figure}
\noindent
At the photopeak, all photon energy is deposited in the detector. The energies with highest emission probability for elements investigated in this experiment are given in \cite{laraweb}:
\begin{itemize}
