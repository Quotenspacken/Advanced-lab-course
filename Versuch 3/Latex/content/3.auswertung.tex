...
As described in Section%~\ref{},Richtiges Kapittel, das den Kontrast K erklärt
the interference contrast $K$ is determined from the minimum and maximum intensities of the interference pattern according to
\begin{equation*}
...
As described in Section%~\ref{},Richtiges Kapittel, das den Brechungsindex von Gas erklärt
the refractive index of a gas is measured by observing the phase shift induced by changing the pressure inside a gas cell placed in one of the two beams.
