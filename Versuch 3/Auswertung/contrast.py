...
# Daten laden
theta, I_max1, I_min1, I_max2, I_min2, I_max3, I_min3  = np.genfromtxt("Versuch 3/data/contrast.dat", unpack = True)
...
plt.savefig("Versuch 3/Latex/build/contrast.pdf", bbox_inches='tight')
plt.close()